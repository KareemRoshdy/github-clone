...
const StickyNav = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-[1280px] mx-auto pb-2 lg:pb-3 pt-2 flex lg:px-3 px-12 items-center max-lg:flex-col relative">
          <button
          ...
          >
            ...
            <a
              ...
              href=""
              className="flex items-center max-lg:w-full text-black bg-white font-semibold px-3 py-3 justify-center rounded-md text-base"
            >
              Sign up for GitHub
              <svg
                xmlns="http://www.w3.org/2000/svg"
