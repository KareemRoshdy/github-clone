  ...
  return (
    <div className="tab rounded-xl border-[0.5px] border-[#30363d] overflow-hidden relative shadow-2xl bg-[#161b22]">
      <div className="flex items-center justify-between border-[0.5px] border-[#30363d] p-4">
        <div className="pre-next max-md:hidden flex text-[#7d8598] font-medium">
          <svg
            aria-hidden="true"
            height="24"
            fill="currentColor"
        ...
        <div className="flex items-center justify-between px-2 py-1 rounded-md bg-[#0b1117] border-[0.5px] border-[#30363d] w-full md:w-auto">
          <svg
            aria-hidden="true"
            height="16"
            fill="currentColor"
      ...
      <div className="flex items-stretch">
        ...
        <div className="min-w-0 w-full">
          <div className="border-b-[0.5px] border-[#30363d] text-[#7d8598]">
