...
const CodeSpace = () => {
  ...
  return (
    <div className="flex relative md:pl-5 ">
      <img
        alt="codeSpaceImage"
        aria-hidden="true"
        width="2712"
      ...
      <div className="flex items-center flex-row relative">
        <motion.div
          ...
          className="w-[3px] max-md:w-[2px] h-full increase origin-top"
        ></motion.div>
      ...
      <div className="lg:pl-24 md:pl-16 pl:6">
        <div className="flex max-md:flex-col-reverse my-8 items-center lg:gap-x-5 sm:my-12 md:my-16 pd-6 md:pb-20 md:flex-row">
        ...
        >
          <div className="py-4 text-left">
            ...
            <h3 className="text-[#7ee787] mb-2 mt-3 lg:text-6xl md:text-5xl font-medium">
              22% increase
            </h3>
