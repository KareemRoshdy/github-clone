...
const Hero = () => {
  ...
  return (
    <div className="relative max-w-[1280px] mx-auto lg:pt-32 md:px10 pt-16">
      <img
      ...
      <div className="flex">
        ...
        <div className="absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12">
          <div className="relative md:top-20 mb-[24px]">
            ...
            >
              <div className="flex items-center p-3 px-5">
                ...
                <div className="mb:pr-5 pr-3 md:mr-2 md:pl-2">
          ...
          <h1 className="md:mt-24 lg:mt-28 sm:mt-10 relative max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[80px] font-semibold text-white">
            Let&apos;s build from&nbsp;here
          </h1>

          <p className="relative text-[24px] md:text-[28px] lg:text-[32px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:w-10/12 lg:w-9/12 text-[#7d8590]">
            ...
            <form action="">
              <div className="grid max-md:grid-rows-2 md:grid-cols-2">
                <dl>
                  <dd>
                    <input
                      className="h-12 focus:outline-none max-md:rounded-md md:rounded-s-md right-0 w-full text-black placeholder:text-[16px] pl-3"
